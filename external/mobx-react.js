  ...
  return /******/ (function(modules) {
    ...
    /******/ [
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        var observableArray = (exports.observableArray = createObservableTypeCheckerCreator(
          false,
          "Array"
        ));
        var observableArrayOf = (exports.observableArrayOf = createObservableArrayOfTypeChecker.bind(
          null,
          false
        ));
        var observableMap = (exports.observableMap = createObservableTypeCheckerCreator(
          false,
          "Map"
        ));
        ...
        var arrayOrObservableArray = (exports.arrayOrObservableArray = createObservableTypeCheckerCreator(
          true,
          "Array"
        ));
        var arrayOrObservableArrayOf = (exports.arrayOrObservableArrayOf = createObservableArrayOfTypeChecker.bind(
          null,
          true
        ));
        var objectOrObservableObject = (exports.objectOrObservableObject = createObservableTypeCheckerCreator(
          true,
          "Object"
        ));
        ...
        function createStoreInjector(grabStoresFn, component, injectNames) {
          ...
          var Injector = ((_temp2 = _class = (function(_Component) {
            ...
            function Injector() {
              ...
              )), _this)), (_this.storeRef = function(instance) {
 ...
 */
        ...
        // WeakMap<Node, Object>;
        var componentByNodeRegistery = (exports.componentByNodeRegistery = typeof WeakMap !==
          "undefined"
          ? new WeakMap()
          : undefined);
 ...
 */
        ...
        function patch(target, funcName) {
          var runMixinFirst = arguments.length > 2 && arguments[2] !== undefined
            ? arguments[2]
            : false;
                  ...
                  if (!isRenderingPending) {
                    ...
                    if (_this.__$mobxIsUnmounted !== true) {
                      ...
                      try {
                        ...
                        if (!skipRender)
                          _react2.default.Component.prototype.forceUpdate.call(
                            _this
                          );
                        hasError = false;
                      } finally {
 ...
 */
        function observer(arg1, arg2) {
          ...
          if (
            ...
            !_react2.default.Component.isPrototypeOf(componentClass)
          ) {
            var _class, _temp;
            ...
            return observer(
              ((_temp = _class = (function(_Component) {
                ...
                componentClass.name), (_class.contextTypes =
                componentClass.contextTypes), (_class.propTypes =
                componentClass.propTypes), (_class.defaultProps =
                componentClass.defaultProps), _temp)
            );
          }
      ...
      /***/ function(module, exports, __webpack_require__) {
        ...
        if (
          "browser" === "browser" &&
          typeof _reactDom.unstable_batchedUpdates === "function"
        )
          mobx.extras.setReactionScheduler(_reactDom.unstable_batchedUpdates);
        if (false)
          mobx.extras.setReactionScheduler(
            _reactNative.unstable_batchedUpdates
          );
